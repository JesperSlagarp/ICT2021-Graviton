...
public class Rotate : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        /*if (playerAngle > 90 || playerAngle < -90)
        {
            //Debug.Log("angle 1");
            this.gameObject.transform.localScale = new Vector3(1, -1, 1);
            this.gameObject.transform.localPosition = new Vector3(weaponPos.x * -1, this.gameObject.transform.localPosition.y, this.gameObject.transform.localPosition.z);
        }
        else if (playerAngle < 90 || playerAngle > -90)
        {
            //Debug.Log("angle 2");
            this.gameObject.transform.localScale = new Vector3(1, 1, 1);
            this.gameObject.transform.localPosition = new Vector3(weaponPos.x, this.gameObject.transform.localPosition.y, this.gameObject.transform.localPosition.z);
        }*/
